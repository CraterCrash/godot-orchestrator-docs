...
| Orchestrator 2.3        | November 2025      | <EditorIcon name="Error" color="#ff5f5f" /> No longer supported (last update: 2.3.7).                                                                                    |
| Orchestrator 2.2        | November 2025      | <EditorIcon name="Error" color="#ff5f5f" /> No longer supported (last update: 2.2.7).                                                                                    |
