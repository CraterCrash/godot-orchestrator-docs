...
* Script Node
  ...
  * [Dictionary](dictionary) 
    * [Make a Dictionary](dictionary#creating-a-dictionary)
    * [Modify a Dictionary](dictionary#setting-value-in-an-existing-dictionary)
  * [Events](events)
  * [Flow Control](flow-control)
    ...
    * [Switch](flow-control#switch)
      * [Switch on Any](flow-control#switch-on-any)
      * [Switch on Enumeration](flow-control#switch-on-enumeration)
      * [Switch on Integer](flow-control#switch-on-integer)
      * [Switch on String](flow-control#switch-on-string)
