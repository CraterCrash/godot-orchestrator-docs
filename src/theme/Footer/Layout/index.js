      ...
      <footer
          ...
          <div className="footer-wrapper">
              ...
              <div className="socials">
                  ...
                  <a href="https://discord.gg/J3UWtzWSkT"><img src="https://gravity.cratercrash.space/227-fsn/i/500as.png" alt="A pink and purple polka-dotted circular icon resembling a stylized smiling face with two large eyes and a curved mouth, representing the Discord logo, set against a transparent background."/></a>
              </div>
          </div>
      </footer>
  );
